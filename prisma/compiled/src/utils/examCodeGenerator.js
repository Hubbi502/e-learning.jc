...
async function generateExamCode(category) {
    ...
    const existingExam = await prisma_1.default.exam.findUnique({
...
function parseExamCode(examCode) {
    ...
    const category = prefix === 'GNG' ? 'Gengo' : 'Bunka';
